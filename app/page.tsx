        ...
        <div className="card lg:col-span-2">
          ...
          <ul className="space-y-2 text-sm">
            <li className="flex justify-between">
              <strong>PRIO3</strong>
              <span className="text-gray-300">R$ 43,20</span>
              <span className="text-green-400">+3,91%</span>
            </li>
            <li className="flex justify-between">
              <strong>PETR4</strong>
              <span className="text-gray-300">R$ 37,10</span>
              <span className="text-green-400">+2,84%</span>
            </li>
            <li className="flex justify-between">
              <strong>BBAS3</strong>
              <span className="text-gray-300">R$ 52,60</span>
              <span className="text-green-400">+2,31%</span>
            </li>
            <li className="flex justify-between">
              <strong>ITUB4</strong>
              <span className="text-gray-300">R$ 33,70</span>
              <span className="text-green-400">+1,95%</span>
            </li>
            <li className="flex justify-between">
              <strong>VALE3</strong>
              <span className="text-gray-300">R$ 68,10</span>
