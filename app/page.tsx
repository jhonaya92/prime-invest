    ...
    <main>
      <section className="glass rounded-2xl p-8 mb-6">
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight">
          Prime Invest:
          <br />
          Seu futuro em mãos de{" "}
          <span className="text-[var(--accent)]">elite</span>.
        </h1>
        <p className="mt-3 text-gray-300 max-w-2xl">
          Dashboard premium com gráficos TradingView, ranking de ações e alertas
          de notícias em tempo real (mock).
        </p>
        <div className="mt-6">
          <a
            href="#"
            className="inline-block px-5 py-3 rounded-xl bg-[var(--accent)] text-black font-semibold"
          >
            Comece agora
          </a>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="card">
            ...
            <p className="text-sm text-gray-400">
              Clique em uma ação em “Mais buscadas” ou use a busca no topo para
      ...
      <section className="card mt-4">
        ...
        <p className="text-sm text-gray-300 mt-1">
          Esta é uma prévia visual (mock) sem conexão com dados oficiais da B3.
          Gráficos TradingView são embeds públicos meramente ilustrativos.
        </p>
      </section>
    </main>
  );
