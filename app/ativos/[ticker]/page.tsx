...
export default async function AssetPage({ params }: Props) {
  ...
  const kpis = [
    ...
    {
      label: "ROE",
      value: q?.roeTTM ? (q.roeTTM * 100).toFixed(1) + "%" : "18,2%",
    },
    {
      label: "Margem Líq.",
      value: q?.profitMargins
        ? (q.profitMargins * 100).toFixed(1) + "%"
        : "12,4%",
    },
    {
      label: "Div.Yield",
      value: q?.dividendYield
        ? (q.dividendYield * 100).toFixed(1) + "%"
        : "9,1%",
    },
        ...
        <div className="flex items-center justify-between gap-4 flex-wrap">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Gráfico + preço em tempo real (quando disponível) e KPIs
              ilustrativos.
            </p>
          </div>
          <div className="text-right">
            ...
            <div className={`text-sm ${pctClass(change)}`}>
        ...
        <div className="grid xl:grid-cols-3 gap-4 mt-4">
          ...
          <div className="card">
            ...
            <div className="mt-4 text-xs text-gray-400">
              * Alguns valores podem estar em modo demo (mock) caso a API esteja
              indisponível.
            </div>
          </div>
        </div>
