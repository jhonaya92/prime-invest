  ...
  return (
    <main>
      <section className="glass rounded-2xl p-6 mb-4">
        ...
        <p className="text-gray-400 text-sm">Gráfico próprio (Lightweight Charts) + KPIs mock + comparador rápido.</p>
      </section>
        ...
        <div className="space-y-4">
          ...
          <div className="card">
            ...
            <ul className="text-sm grid grid-cols-2 gap-2">
              {peers.map((s,i)=>(
                <li key={i}>
                  <a className="link block bg-white/5 rounded-lg px-3 py-2 text-center" href={`/ativos/${encodeURIComponent(s)}`}>
                    {s.split(":").pop()}
                  </a>
                </li>
              ))}
