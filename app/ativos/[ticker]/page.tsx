...
const kpis = [
  ...
  { label: "Margem L�quida", value: "12,4%" },
  { label: "Div. L�q./EBITDA", value: "0,8x" },
    ...
    <main>
      <section className="glass rounded-2xl p-6 mb-4">
        ...
        <p className="text-gray-400 text-sm">
          Gr�fico TradingView e KPIs ilustrativos (mock) + comparador r�pido.
        </p>
      </section>
      ...
      <section className="grid xl:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <div className="card">
            <div className="text-sm text-gray-300 mb-2">Comparar r�pido</div>
